...
kernel_autoL6:
	...
	lw	a1, %lo(%larel(DMA_portal_ptr,kernel_autoL6))(a2)
	sw	a0, 0(a1) 
kernel_autoL7:
	auipc	a0, %hi(%pcrel(kernel_limit))
	lw	a1, %lo(%larel(kernel_limit,kernel_autoL7))(a0)
	lw	a3, %lo(%larel(DMA_portal_ptr,kernel_autoL6))(a2)
	sw	a1, 4(a3) 
	lw	a3, -24(s0) 
	lw	a1, 8(a3) 
	lw	a3, 4(a3) 
	sub	a1, a1, a3 
	lw	a2, %lo(%larel(DMA_portal_ptr,kernel_autoL6))(a2)
	sw	a1, 8(a2) 
	lw	a0, %lo(%larel(kernel_limit,kernel_autoL7))(a0)
	call	userspace_jump 
	j	kernel_LBB1_3 
kernel_LBB1_3:
	lw	ra, 28(sp) # 4-byte Folded Reload 
