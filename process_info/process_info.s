...
process_info_LBB2_3:                                # =>This Innerprocess_info_Loop Header: Depth=1
	...
	call	print
	lui	a0, %hi(process_info_L.str.6)
	addi	a0, a0, %lo(process_info_L.str.6)
	call	print
	lw	a0, -16(s0)
	lw	a0, 64(a0)
	sw	a0, -16(s0)
...
process_info_L.str.5:
	.asciz	", PC: "
	.size	process_info_L.str.5, 7

	.type	process_info_L.str.6,@object                # @.str.6
process_info_L.str.6:
	.asciz	"\n"
	.size	process_info_L.str.6, 2
